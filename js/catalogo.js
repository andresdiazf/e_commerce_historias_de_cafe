function renderizarProductosStorage() {
      ...
      const cardHTML = `
        <article class="card">
          <div class="image-placeholder">
            <img src="${prod.imagen}" onerror="this.src='https://placeholder.com'"
                 alt="${prod.nombre}" style="width:auto; height:100%; object-fit:contain;">
          </div>
  ...
  // Avisa que el catálogo ya creo las tarjetas, si initCart ya corrió, adjunta listeners ahora mismo y Si todavía no corrió, initCart los adjuntará cuando arranque//
